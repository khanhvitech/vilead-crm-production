...
export function ReportFilters({ 
  ...
  return (
    <div className="bg-white rounded-[10px] border p-4 sticky top-0 z-10">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        {filters.period === 'custom' && (
          <div className="flex items-center gap-2 ml-0 sm:ml-4">
            ...
            <input
              ...
              className="px-3 py-1.5 text-sm border rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#3e79f7]"
            />
        ...
        <div className="flex-1 flex justify-end">
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-4 py-1.5 text-sm bg-blue-500 text-white rounded-[10px] hover:bg-[#3e79f7] transition-colors disabled:opacity-50"
          >
