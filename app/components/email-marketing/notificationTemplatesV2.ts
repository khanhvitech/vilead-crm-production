// ==================== NOTIFICATION TEMPLATES V2.0 ====================
// Based on EMAIL_TEMPLATES_SPECIFICATION.md v2.0
// Design Philosophy: "Content-first, clean & professional"
// - Tối giản: Không icon trang trí, không gradient, không shadow
// - Chuyên nghiệp: Typography sạch, hierarchy rõ ràng, spacing nhất quán
// - Tương thích: HTML table-based layout, inline CSS
// - Responsive: 600px desktop, 100% mobile

import { EmailTemplate } from './types';

// ==================== BASE TEMPLATE COMPONENTS ====================
// Logo ViLead CRM - Direct image URLs
const LOGO_URL = 'https://iili.io/fZzBGxp.png';
const LOGO_WHITE_URL = 'https://iili.io/fZzEz3g.png';
...
<tr>
  <td style="padding:24px 32px; background-color:#FFFFFF;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td>
          <img src="${LOGO_URL}" alt="ViLead CRM" width="150" height="auto" style="display:block;" />
        </td>
      </tr>
    </table>
  </td>
...
<!-- Blue Gradient Line -->
<tr>
  <td style="padding:0; height:4px; background: linear-gradient(90deg, #0067BF 0%, #2563EB 50%, #60A5FA 100%);">
    <!--[if mso]>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="background-color:#0067BF; height:4px; line-height:4px; font-size:4px;">&nbsp;</td></tr>
    </table>
    <![endif]-->
  </td>
</tr>`;
...
<tr>
  <td style="padding:0;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#0067BF; max-width:100%; table-layout:fixed;">
      <tr>
        <td style="padding:20px 24px; word-wrap:break-word;">
          <!-- Logo -->
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="max-width:100%;">
            <tr>
              <td style="padding-bottom:15px;">
                <img src="${LOGO_WHITE_URL}" alt="ViLead CRM" width="150" height="auto" style="display:block; max-width:100%; height:auto;" />
              </td>
            </tr>
          </table>
          <!-- Company Name -->
          <p style="margin:0 0 10px 0; font:bold 14px Tahoma, Arial, sans-serif; color:#FFFFFF;">
            CÔNG TY CỔ PHẦN VILEAD
          </p>
          <!-- Address -->
          <p style="margin:0 0 5px 0; font:13px Tahoma, Arial, sans-serif; color:#FFFFFF; word-wrap:break-word;">
            <strong>Địa chỉ:</strong> Tầng 4, Tòa nhà Stellar Garden, 35 Lê Văn Thiêm, Thanh Xuân Trung, Thanh Xuân, Hà Nội.
          </p>
          <!-- Hotline -->
          <p style="margin:0 0 5px 0; font:13px Tahoma, Arial, sans-serif; color:#FFFFFF;">
            Hotline: 0966.363.373 | (0246) 291 6668 (CSKH – 24/7)
          </p>
          <!-- Email -->
          <p style="margin:0 0 5px 0; font:13px Tahoma, Arial, sans-serif; color:#FFFFFF;">
            Email: <a href="mailto:support@vilead.vn" style="color:#FFFFFF; text-decoration:underline;">support@vilead.vn</a>
          </p>
          <!-- Website -->
          <p style="margin:0 0 10px 0; font:13px Tahoma, Arial, sans-serif; color:#FFFFFF;">
            Website: <a href="https://vilead.vn/" style="color:#FFFFFF; text-decoration:underline;">vilead.vn</a>
          </p>
        </td>
      </tr>
    </table>
...
const OTP_VERIFICATION_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="background-color:#2563EB; border-radius:8px;">
                    <a href="{{login_url}}" target="_blank" style="display:inline-block; padding:14px 40px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none; letter-spacing:0.3px;">
                      Đăng nhập ngay
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="background-color:#2563EB; border-radius:8px;">
                    <a href="{{reset_url}}" target="_blank" style="display:inline-block; padding:14px 40px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none; letter-spacing:0.3px;">
                      Đặt lại mật khẩu
                    </a>
                  </td>
                </tr>
...
const PASSWORD_CHANGED_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
// ==================== TEMPLATE 5: NEW DEVICE LOGIN ====================
const NEW_DEVICE_LOGIN_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Đăng nhập mới từ thiết bị lạ</title>
</head>
<body style="margin:0; padding:0; background-color:#F9FAFB;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F9FAFB;">
    <tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;">
                <tr>
                  <td align="center" style="background-color:#DC2626; border-radius:8px;">
                    <a href="{{secure_account_url}}" target="_blank" style="display:inline-block; padding:14px 36px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none;">
...
const SECURITY_ALERT_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
const PAYMENT_REMINDER_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="background-color:#2563EB; border-radius:8px;">
                    <a href="{{payment_url}}" target="_blank" style="display:inline-block; padding:14px 40px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none; letter-spacing:0.3px;">
                      Thanh toán ngay
                    </a>
                  </td>
                </tr>
...
// ==================== TEMPLATE 8: SUBSCRIPTION EXPIRY ====================
const SUBSCRIPTION_EXPIRY_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="background-color:#2563EB; border-radius:8px;">
                    <a href="{{renew_url}}" target="_blank" style="display:inline-block; padding:14px 40px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none; letter-spacing:0.3px;">
                      Gia hạn ngay
                    </a>
                  </td>
                </tr>
...
// ==================== TEMPLATE 9: CAMPAIGN REPORT ====================
const CAMPAIGN_REPORT_HTML = `<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Báo cáo kết quả chiến dịch</title>
</head>
<body style="margin:0; padding:0; background-color:#F9FAFB;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F9FAFB;">
    <tr>
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px;">
                <tr>
                  <td align="center" style="background-color:#2563EB; border-radius:8px;">
                    <a href="{{report_url}}" target="_blank" style="display:inline-block; padding:14px 40px; font:600 15px 'Segoe UI', Arial, sans-serif; color:#FFFFFF; text-decoration:none; letter-spacing:0.3px;">
...
export const NOTIFICATION_TEMPLATES_V2: EmailTemplate[] = [
  // 1. OTP Verification
  {
    id: 'tpl-notif-001',
    name: 'Mã xác thực OTP',
    type: 'notification',
    content_html: OTP_VERIFICATION_HTML,
    content_json: null,
    editor_mode: 'html',
  ...
  // 2. Password Changed
  {
    ...
    type: 'notification',
    content_html: PASSWORD_CHANGED_HTML,
    content_json: null,
    editor_mode: 'html',
  ...
  // 3. New Device Login
  {
    ...
    type: 'notification',
    content_html: NEW_DEVICE_LOGIN_HTML,
    content_json: null,
    editor_mode: 'html',
  ...
  // 4. Password Reset
  {
    ...
    content_json: null,
    editor_mode: 'html',
    thumbnail_url: '/templates/thumbnails/notification/password-reset.png',
    owner_id: null,
    category_id: 'cat-security',
    version: 2,
    versions: [],
  ...
  // 5. Security Alert
  {
    ...
    type: 'notification',
    content_html: SECURITY_ALERT_HTML,
    content_json: null,
    editor_mode: 'html',
    thumbnail_url: '/templates/thumbnails/notification/security-alert.png',
    owner_id: null,
    category_id: 'cat-security',
    version: 2,
    versions: [],
  ...
  // 7. Payment Reminder
  {
    ...
    type: 'notification',
    content_html: PAYMENT_REMINDER_HTML,
    content_json: null,
    editor_mode: 'html',
  ...
  {
    id: 'tpl-notif-008',
    name: 'Thông báo hết hạn dịch vụ',
    type: 'notification',
    content_html: SUBSCRIPTION_EXPIRY_HTML,
    content_json: null,
    editor_mode: 'html',
    thumbnail_url: '/templates/thumbnails/notification/subscription-expiry.png',
    owner_id: null,
    category_id: 'cat-billing',
    version: 2,
    versions: [],
  ...
  {
    id: 'tpl-notif-009',
    name: 'Báo cáo kết quả chiến dịch',
    type: 'notification',
    content_html: CAMPAIGN_REPORT_HTML,
    content_json: null,
    editor_mode: 'html',
...
export default NOTIFICATION_TEMPLATES_V2;
