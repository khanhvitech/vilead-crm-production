                ...
                <div className="w-full lg:w-[55%] flex flex-col justify-center h-full pt-2 gap-y-6 border-t lg:border-t-0 lg:border-l border-gray-100 lg:pl-10">
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-between items-end mb-2.5">
                      ...
                      <span className="font-extrabold text-gray-900 text-sm leading-none">8/10</span>
                    </div>
                    <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden mb-1.5">
                      <div className="h-full bg-[#d97706] w-[80%] rounded-full shadow-sm"></div>
                    </div>
                    <div className="text-[11px] text-gray-400 font-medium italic">Tăng giới hạn với +150k/user/tháng</div>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="text-[11px] text-gray-400 font-medium italic">Tối ưu hơn với tính năng nén file</div>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden mb-1.5">
                      <div className="h-full bg-[#10b981] w-[40%] rounded-full shadow-sm"></div>
                    </div>
                    <div className="text-[11px] text-gray-400 font-medium italic">Facebook, Zalo, Web Live Chat</div>
                  </div>
              ...
              <div className="mt-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-4">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col">
                    ...
                    <button className="w-full py-2.5 rounded-xl border-2 border-gray-200 text-gray-900 font-bold text-[13px] hover:bg-gray-50 transition-colors mt-auto">
                      Bắt đầu ngay
                    </button>
                  </div>

                  {/* Professional */}
                  <div className="bg-white rounded-2xl border-[3px] border-[#f97316] shadow-lg p-6 flex flex-col relative transform md:-translate-y-3">
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#f97316] text-white px-3 py-1 rounded-full text-[10px] font-extrabold shadow-sm whitespace-nowrap">
                      PHỔ BIẾN NHẤT
                    </div>
                    <div className="mb-5 mt-1">
                      <h3 className="text-[#ea580c] font-bold text-xs tracking-wider uppercase mb-2">Professional</h3>
                      <div className="flex items-baseline">
                    ...
                    <ul className="flex-1 space-y-3 mb-6">
                      {['Tất cả tính năng Starter', 'Phân bổ lead tự động + gắn nhãn tự động', 'Thông báo nâng cao', 'Combo, voucher, khuyến mãi', 'Báo cáo nâng cao', 'Email marketing', 'Quản lý chat (3 tài khoản)'].map((feat, idx) => (
                        <li key={idx} className="flex items-start">
                          <CheckCircle2 className="w-4 h-4 text-[#f59e0b] shrink-0 mr-2.5" />
                          <span className="text-[13px] text-gray-800 font-bold leading-tight">{feat}</span>
                        </li>
                      ))}
                    </ul>
                    <button className="w-full py-2.5 rounded-xl bg-[#f97316] hover:bg-[#ea580c] text-white font-bold text-[13px] transition-colors shadow-md mt-auto">
                      Nâng cấp ngay
                    </button>
                  </div>
