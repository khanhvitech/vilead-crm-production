...
export const UpgradeModal: React.FC<UpgradeModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[500px] p-0 border-0 rounded-xl overflow-hidden bg-white shadow-xl">
        ...
        <div className="p-6">
          <div className="bg-[#fff7ed] border border-[#fed7aa] rounded-xl p-5 mb-6 text-sm text-gray-800 font-medium">
